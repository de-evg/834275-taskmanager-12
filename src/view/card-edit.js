...
const createCardEditColorsTemplate = (currentColor) => {
...
const createCardEditTemplate = (task = {}) => {
  ...
  const repeatingTemplate = createCardEditRepeatingTemplate(repeating);

  const colorsTemplate = createCardEditColorsTemplate(color);
